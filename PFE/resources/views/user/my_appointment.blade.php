...
<body>
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        <a class="navbar-brand" href="{{url('/')}}"><span class="text-primary">PFE</span>-EST</a>
			...
			<div>
			  ...
			  <tbody>
			    ...
			    <tr>
			      ...
			      <td> <a  class="btn btn-dark" onclick="return confirm('Are you sure to delete this appointment ?')" href="{{url('cancel_appoint',$appoints -> id)}}">Cancel this appointment</a> </td>
