                            ...
                            <form method="POST" action="{{ url('editdoctor',$data->id)}}" enctype="multipart/form-data"  class="bg-dark" >
                                    {{csrf_field()}}
                                          ...
                                          <label for="firstname" class="form-label">Full Name</label>
                                                <input type="text" class="form-control" name = "Full_Name" id="Full_Name"  required="" style="color:black" value="{{$data -> Full_Name}}" readonly="readonly">
                                              ...
                                              <label for="exampleInputEmail1" class="form-label">Phone Number </label>
                                                ...
                                                <input type="email" class="form-control" id="Email_Adress" name="Email_Adress" aria-describedby="emailHelp" style="color:black" required="" value="{{$data -> Email_Adress}}" readonly="readonly">
